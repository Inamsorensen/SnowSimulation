...
void OpenGL_Scene::resizeGL(QResizeEvent *_event )
{
...
void OpenGL_Scene::resizeGL(int _w , int _h)
{
  m_cam.setShape(45.0f,(float)_w/_h,0.05f,350.0f);
  m_width=_w*devicePixelRatio();
  m_height=_h*devicePixelRatio();
}
void OpenGL_Scene::initializeGL()
{
...
//----------------------------------------------------------------------------------------------------------------------
void OpenGL_Scene::mouseMoveEvent (QMouseEvent * _event)
{
  NGL_UNUSED(_event);
}
...
//----------------------------------------------------------------------------------------------------------------------
void OpenGL_Scene::mousePressEvent ( QMouseEvent * _event)
{
  NGL_UNUSED(_event);
...
//----------------------------------------------------------------------------------------------------------------------
void OpenGL_Scene::mouseReleaseEvent ( QMouseEvent * _event )
{
  NGL_UNUSED(_event);
...
//----------------------------------------------------------------------------------------------------------------------
void OpenGL_Scene::wheelEvent(QWheelEvent *_event)
{
...
void OpenGL_Scene::keyPressEvent(QKeyEvent *_event)
{
